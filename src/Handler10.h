...
// Handler10 - Command 10 Handler (After School Menu / Demo Choice Screen)
// Size: 0x6A8 bytes
// vtable: 0x431110
...
public:
    ...
    virtual void Update(SC_Message* param1, int param2);
    virtual int Draw(SC_Message* msg);
    ...
    void SetCharacterOptionInternal();
...
// Global character objects created in Handler10 constructor
