...
/* Function start: 0x403340 */ /* DEMO ONLY - no full game match */
Handler1::Handler1() {
    palette = 0;
    sprite = 0;
    handlerId = 1;
...
/* Function start: 0x44E740 */ /* ~90% match */
Handler1::~Handler1() {
    if (sprite) {
        delete sprite;
        sprite = 0;
...
/* Function start: 0x403570 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x4035C0 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x403650 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x4036C0 */ /* DEMO ONLY - no full game match */
