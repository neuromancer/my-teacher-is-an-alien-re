...
public:
    ...
    int displayMode;        // offset 0x08
    HWND hWnd;              // offset 0x0C
    HDC hDC;                // offset 0x10
    HGDIOBJ hPalette;       // offset 0x14
    int field_18;           // offset 0x18
    int field_1c;           // offset 0x1C
    int fullscreenMode;     // offset 0x20 - fullscreen mode flag
    int startupParam;       // offset 0x24
    int initialized;        // offset 0x28 - initialized flag
