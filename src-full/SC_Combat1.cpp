...
/* Function start: 0x410650 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x43B720 */ /* ~82% match */
SC_Combat1::~SC_Combat1() {
    Parser* pParser;
...
/* Function start: 0x410810 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x410B00 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x410CA0 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x410E80 */ /* DEMO ONLY - no full game match */
    ...
    if (strcmp(label, "MODULE") == 0) {
        if (sscanf(line, "%s %s", label, moduleType) == 2) {
            if (strcmp(moduleType, g_EngineTypeCombat_00435ef4) == 0) {
                g_CombatEngine_00435eb0 = (SC_CombatBase*)new EngineB();
