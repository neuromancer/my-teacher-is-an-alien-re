...
/* Function start: 0x40ACC0 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x40AD70 */ /* DEMO ONLY - no full game match */
SCI_SearchScreen::~SCI_SearchScreen() {
    Palette* pal;
    MMPlayer* mouse;
    MMPlayer2* dialog;
...
/* Function start: 0x40AE80 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x40AFD0 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x40B0B0 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x40B110 */ /* DEMO ONLY - no full game match */
int SCI_SearchScreen::Exit(SC_Message* msg) {
    return handlerId == msg->targetAddress;
}

/* Function start: 0x40B130 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x40B230 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x40B2B0 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x40B2E0 */ /* DEMO ONLY - no full game match */
