...
/* Function start: 0x40F710 */ /* DEMO ONLY - no full game match */
Handler2::Handler2() {
    int* pA0;
...
/* Function start: 0x40F8F0 */ /* DEMO ONLY - no full game match */
Handler2::~Handler2() {
    if (sample) {
        sample->Unload();
...
/* Function start: 0x40F9E0 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x40FA30 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x40FA90 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x40FAD0 */ /* DEMO ONLY - no full game match */
int Handler2::Exit(SC_Message* msg) {
    return handlerId == msg->targetAddress;
}

/* Function start: 0x40FAF0 */ /* DEMO ONLY - no full game match */
