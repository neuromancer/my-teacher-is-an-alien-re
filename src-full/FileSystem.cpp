...
/* Function start: 0x426470 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x426550 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x42DDD0 */ /* DEMO ONLY - no full game match */
void __cdecl GetCurrentDir(char *buffer, int size)
{
    GetDriveDir(0, buffer, size);
}

/* Function start: 0x42DDF0 */ /* DEMO ONLY - no full game match */
...
/* Function start: 0x42DF20 */ /* DEMO ONLY - no full game match */
